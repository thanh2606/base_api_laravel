...
export const columns: ColumnDef<AttributeResourceInterface>[] = [
	{
		id: 'select',
		meta: {
	...
	},
	{
		...
		cell: ({ row }) => {
			...
			return h(
				...
				{},
				h(Actions, {
					editUrl: route('admin.attributes.show', { attribute: data.id }),
					deleteUrl: route('admin.attributes.destroy', { attribute: data.id }),
				})
			)
		},
	},
