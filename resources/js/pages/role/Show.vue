			...
			>
				<div class="grid gap-4">
					...
					<div class="grid w-full items-center gap-1.5">
						...
						<Select
							:default-value="role.status.toString()"
							id="status"
							name="status"
						>
						...
						<TableBody>
							...
							>
								...
								>
									<Checkbox
										name="permissions[]"
										:default-value="defaultPermission(permission.id)"
										:value="permission.id"
									/>
								</TableCell>
							</TableRow>
...
<script lang="ts" setup>
	...
	const role = usePage().props.role as RoleResourceInterface
	...
	const defaultPermission = (id: number) => {
		return role.permissions.some((item) => item.id === id)
	}
