	...
	},
	{
		...
		cell: ({ row }) => {
			...
			return h(
				...
				{},
				h(Actions, {
					editUrl: route('admin.categories.show', { category: data.id, type: EnumCategoryType.PRODUCT }),
					deleteUrl: route('admin.categories.destroy', { category: data.id, type: EnumCategoryType.PRODUCT }),
				})
			)
		},
	},
