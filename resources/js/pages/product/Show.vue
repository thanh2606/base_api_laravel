			...
			<div class="grid grid-cols-12 h-full p-4 gap-4 w-full max-w-[calc(100vw-6.25rem)]">
				<div class="col-span-12 md:col-span-8 2xl:col-span-9">
					<div class="grid gap-4">
						...
						<template v-if="form.type === EnumProductType.VARIABLE"> </template>
					</div>
				</div>
...
import { MediaInterface } from '@/responses/media/MediaResource'
	...
	const page = usePage()
	const product = page.props.record
	const errors = page.props.errors as Record<string, string>
	const selectCategories: Array<number> = page.props.selectCategories as number[]
	const selectTags: Array<number> = page.props.selectTags as number[]
	const selectGalleries: Array<number> = page.props.selectGalleries as number[]
	const galleries: Array<MediaInterface> = page.props.galleries as Array<MediaInterface>
	...
	const {
		...
		submit
	} = useProductForm(product, selectCategories, selectTags, selectGalleries)
