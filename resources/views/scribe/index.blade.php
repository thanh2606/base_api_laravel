...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
        ...
        <h1 id="auth">Auth</h1>
                                ...
                                <h2 id="auth-POSTapi-register">Đăng ký tài khoản</h2>

<p>
</p>

<p>Đăng ký tài khoản mới bằng số điện thoại và mật khẩu.
Sau khi đăng ký, hệ thống sẽ gửi mã OTP đến số điện thoại để xác thực.</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Đăng k&yacute; th&agrave;nh c&ocirc;ng, vui l&ograve;ng nhập m&atilde; OTP được gửi qua SMS để x&aacute;c thực số điện thoại.&quot;,
    &quot;phone&quot;: &quot;0901234567&quot;
}</code>
 </pre>
            <blockquote>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Số điện thoại duy nhất. Ví dụ: 0901234567 Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Họ tên người dùng. Ví dụ: Nguyen Van A Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Mật khẩu. Tối thiểu 6 ký tự. Ví dụ: password123 Example: <code>|]|{+-</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nhập lại mật khẩu. Phải trùng với password. Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="auth-POSTapi-verify-otp">Xác thực OTP</h2>

<p>
</p>

<p>Xác thực mã OTP đã gửi tới số điện thoại sau khi đăng ký.
Nếu mã hợp lệ, số điện thoại sẽ được đánh dấu đã xác thực và hệ thống trả về token đăng nhập.</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;X&aacute;c thực th&agrave;nh c&ocirc;ng.&quot;,
    ...
    &quot;user&quot;: {
        ...
        &quot;updated_at&quot;: &quot;2025-01-01T11:00:00.000000Z&quot;
            ...
            <blockquote>
            <p>Example response (422, Mã OTP sai):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;errors&quot;: {
        &quot;code&quot;: [
            ...
            <blockquote>
            <p>Example response (422, Mã OTP hết hạn hoặc đã dùng):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;errors&quot;: {
        &quot;code&quot;: [
            &quot;M&atilde; đ&atilde; được sử dụng hoặc đ&atilde; hết hạn.&quot;
        ]
    }
}</code>
 </pre>
            <blockquote>
            <p>Example response (422, Vượt quá số lần nhập mã):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;errors&quot;: {
        &quot;code&quot;: [
            &quot;Bạn đ&atilde; vượt qu&aacute; số lần nhập m&atilde; cho ph&eacute;p.&quot;
        ]
    }
}</code>
 </pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Số điện thoại đã đăng ký. Ví dụ: 0901234567 Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Mã OTP gồm 6 chữ số. Ví dụ: 123456 Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="auth-POSTapi-resend-otp">Gửi lại mã OTP</h2>

<p>
</p>

<p>Gửi lại mã OTP cho số điện thoại đã đăng ký.
Có giới hạn thời gian giữa các lần gửi (VD: 60 giây).</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Đ&atilde; gửi lại m&atilde; OTP.&quot;,
    &quot;phone&quot;: &quot;0901234567&quot;
}</code>
 </pre>
            <blockquote>
            <p>Example response (422, Gửi lại quá sớm):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;errors&quot;: {
        &quot;phone&quot;: [
            &quot;Vui l&ograve;ng đợi 30 gi&acirc;y nữa trước khi y&ecirc;u cầu m&atilde; mới.&quot;
        ]
    }
}</code>
 </pre>
            <blockquote>
            <p>Example response (422, Số điện thoại không tồn tại):</p>
        </blockquote>
                <pre>
...
<form id="form-POSTapi-resend-otp" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-resend-otp');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-resend-otp"
                    onclick="cancelTryOut('POSTapi-resend-otp');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Số điện thoại đã đăng ký. Ví dụ: 0901234567 Example: <code>architecto</code></p>
                    ...
                    <h2 id="auth-POSTapi-login">Đăng nhập</h2>

<p>
</p>

<p>Đăng nhập bằng số điện thoại và mật khẩu.
Trả về Bearer Token (Sanctum) để dùng cho các API cần auth.</p>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;errors&quot;: {
        &quot;phone&quot;: [
            &quot;Th&ocirc;ng tin đăng nhập kh&ocirc;ng ch&iacute;nh x&aacute;c.&quot;
        ]
    }
}</code>
 </pre>
            <blockquote>
            <p>Example response (422, Chưa verify số điện thoại):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;errors&quot;: {
        &quot;phone&quot;: [
            &quot;Số điện thoại chưa được x&aacute;c thực.&quot;
        ]
    }
}</code>
 </pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Mật khẩu. Ví dụ: password123 Example: <code>|]|{+-</code></p>
        </div>
        </form>

                    <h2 id="auth-GETapi-me">Thông tin user hiện tại</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Lấy thông tin user tương ứng với Bearer token đang sử dụng.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="auth-POSTapi-change-password">Đổi mật khẩu</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Đổi mật khẩu cho user đang đăng nhập.</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Đổi mật khẩu th&agrave;nh c&ocirc;ng.&quot;
}</code>
 </pre>
            <blockquote>
            <p>Example response (401):</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <blockquote>
            <p>Example response (422, Sai mật khẩu hiện tại):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;errors&quot;: {
        &quot;current_password&quot;: [
            &quot;Mật khẩu hiện tại kh&ocirc;ng đ&uacute;ng.&quot;
        ]
    }
}</code>
 </pre>
            <blockquote>
            <p>Example response (422, Nhập lại mật khẩu mới không khớp):</p>
        </blockquote>
                <pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Mật khẩu hiện tại. Ví dụ: oldpass123 Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Mật khẩu mới. Tối thiểu 6 ký tự. Ví dụ: newpass123 Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nhập lại mật khẩu mới. Phải trùng với new_password. Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="auth-POSTapi-logout">Đăng xuất</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Thu hồi (revoke) Bearer token hiện tại của user.</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Đăng xuất th&agrave;nh c&ocirc;ng.&quot;
}</code>
 </pre>
            <blockquote>
            <p>Example response (401):</p>
